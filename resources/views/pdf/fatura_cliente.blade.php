...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .doc-number { font-size: 14px; color: #555; margin-bottom: 24px; }
...
<div class="page">
    ...
    <div class="doc-number">Nº {{ $numero_ft }}</div>

    <div class="doc-meta">
        <div>
            <div class="label">Data de Emissão</div>
            <div>{{ $encomenda->data_encomenda?->format('d/m/Y') ?? now()->format('d/m/Y') }}</div>
        </div>
        <div>
            <div class="label">Ref. Encomenda</div>
