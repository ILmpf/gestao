...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .supplier-box { border: 1px solid #e0e0e0; border-radius: 4px; padding: 12px 16px; margin-bottom: 24px; background: #fafafa; }
    .supplier-box .label { font-weight: bold; font-size: 10px; text-transform: uppercase; color: #555; margin-bottom: 4px; }
...
<div class="page">
    ...
    <div class="doc-title">Encomenda Fornecedor {{ $encomenda->numero }}</div>
    ...
    <div class="totals">
        <table>
            @php $total = $encomenda->linhas->sum('subtotal'); @endphp
