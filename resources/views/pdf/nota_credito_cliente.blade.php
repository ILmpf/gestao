...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .doc-title { font-size: 22px; font-weight: bold; color: #1a1a1a; margin-bottom: 4px; }
    .doc-number { font-size: 14px; color: #555; margin-bottom: 4px; }
    .doc-ref { font-size: 11px; color: #888; margin-bottom: 24px; }
    ...
    .totals .total-row { font-weight: bold; font-size: 13px; border-top: 2px solid #1a1a1a; color: #1a1a1a; }
    .notice { padding: 10px 0; margin-bottom: 24px; font-size: 11px; font-weight: bold; color: #1a1a1a; }
...
<div class="page">
    ...
    <div class="doc-number">Nº {{ $numero_nc }}</div>
    <div class="doc-ref">Ref. Encomenda: {{ $encomenda->numero }}</div>
    ...
    <div class="doc-meta">
        ...
        <div>
            <div class="label">Encomenda Cancelada</div>
            <div>{{ $encomenda->numero }}</div>
        </div>
    </div>

    <div class="notice">
        Estorno da Fatura {{ $numero_fatura ?? $encomenda->numero }}
    </div>
