...
return new class extends Migration
{
    ...
    {
        Schema::create('notas_credito_clientes', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('fatura_cliente_id')->nullable()->constrained('faturas_clientes')->nullOnDelete();
    ...
    {
        Schema::dropIfExists('notas_credito_clientes');
    }
};
